        ...
        <div className="settings">
            <div className="settings-wrapper">
                <div className="settings-tittle">
                    <span className="settings-update-tittle">Update Your Account</span>
                    <span className="settings-delete-tittle">Delete Account</span>
                </div>
                <form className="settings-form" onSubmit={handleSubmit}>
                    ...
                    <label>Email</label>
                    <input type="email" 
                        placeholder="Shantocuet659@gmail.com" 
